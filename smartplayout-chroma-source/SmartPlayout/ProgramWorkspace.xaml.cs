...
public partial class ProgramWorkspace : System.Windows.Controls.UserControl
{
    ...
    private void UpdateStablePreviewRenderTarget()
    {
        ...
        _previewRenderWidth=width; _previewRenderHeight=height;
    ...
    public void SetHardwareDecodeEnabled(bool enabled) => _preview.HardwareDecodeEnabled = enabled;

    public ProgramWorkspace()
    {
        InitializeComponent();
        ...
        // SmartPlayer final seek behavior: slider movement is visual only.
        // Perform the expensive MPEG keyframe seek once on mouse release, not every 90 ms.
